...
public class ListTypeItemTest {
    ...
    void from_singularGenericTypeItem() {
        ListTypeItem<String> listTypeItem = ListTypeItem.from(Item.from("1234", "str"));
    ...
    void from_varargsGenericTypeItem() {
        ListTypeItem<String> listTypeItem = ListTypeItem.from(Item.from("1"), Item.from("2"));
    ...
    void concat_varargsListTypeItem() {
        ListTypeItem<String> listOne = ListTypeItem.from(Item.from("1"), Item.from("2"));
        ListTypeItem<String> listTwo = ListTypeItem.from(Item.from("3"), Item.from("4"));
